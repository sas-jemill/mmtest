...
in_out varchar(100) "EM_CLASSIFICATION");
   ...
   if null(pm) then do;
      pm = _new_ pymas();
      resultCode = pm.useModule('model_exec_f0565232-e1e4-4bac-a733-99f79f6fe3cf', 1);
      if resultCode then do;
         ...
         resultCode = pm.appendSrcLine('import hmeq_logistic_score_e49083dd_afaa_4058_bb27_10cd633b3e26');
         ...
         resultCode = pm.appendSrcLine('    return hmeq_logistic_score_e49083dd_afaa_4058_bb27_10cd633b3e26.scoreHMEQLogisticModel(JOB, REASON, CLAGE, CLNO, DEBTINC, DELINQ, DEROG, NINQ, YOJ)');

         revision = pm.publish(pm.getSource(), 'model_exec_f0565232-e1e4-4bac-a733-99f79f6fe3cf');
