...
in_out varchar(100) "EM_CLASSIFICATION");
   ...
   if null(pm) then do;
      pm = _new_ pymas();
      resultCode = pm.useModule('model_exec_215413ac-2a78-4bed-bc84-2f66c7098940', 1);
      if resultCode then do;
         ...
         resultCode = pm.appendSrcLine('import hmeq_logistic_score_6cec2767_d241_4c18_b5a0_0245ca63750f');
         ...
         resultCode = pm.appendSrcLine('    return hmeq_logistic_score_6cec2767_d241_4c18_b5a0_0245ca63750f.scoreHMEQLogisticModel(JOB, REASON, CLAGE, CLNO, DEBTINC, DELINQ, DEROG, NINQ, YOJ)');

         revision = pm.publish(pm.getSource(), 'model_exec_215413ac-2a78-4bed-bc84-2f66c7098940');
