...
in_out varchar(100) "EM_CLASSIFICATION");
   ...
   if null(pm) then do;
      pm = _new_ pymas();
      resultCode = pm.useModule('model_exec_c21612c1-c88f-4174-8e3d-2174faf70f70', 1);
      if resultCode then do;
         ...
         resultCode = pm.appendSrcLine('import hmeq_logistic_score_c8e47956_0c1d_49c9_8265_bb9abc4abd8b');
         ...
         resultCode = pm.appendSrcLine('    return hmeq_logistic_score_c8e47956_0c1d_49c9_8265_bb9abc4abd8b.scoreHMEQLogisticModel(JOB, REASON, CLAGE, CLNO, DEBTINC, DELINQ, DEROG, NINQ, YOJ)');

         revision = pm.publish(pm.getSource(), 'model_exec_c21612c1-c88f-4174-8e3d-2174faf70f70');
