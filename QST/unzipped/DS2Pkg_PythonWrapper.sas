...
in_out varchar(100) "EM_CLASSIFICATION");
   ...
   if null(pm) then do;
      pm = _new_ pymas();
      resultCode = pm.useModule('model_exec_db4d112d-1a29-45dd-b915-add4f4d7230f', 1);
      if resultCode then do;
         ...
         resultCode = pm.appendSrcLine('import hmeq_logistic_score_d64f993b_c414_4567_831e_de39c58ef86c');
         ...
         resultCode = pm.appendSrcLine('    return hmeq_logistic_score_d64f993b_c414_4567_831e_de39c58ef86c.scoreHMEQLogisticModel(JOB, REASON, CLAGE, CLNO, DEBTINC, DELINQ, DEROG, NINQ, YOJ)');

         revision = pm.publish(pm.getSource(), 'model_exec_db4d112d-1a29-45dd-b915-add4f4d7230f');
